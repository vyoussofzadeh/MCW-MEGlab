...
LI_analysis_label = {'DICS_indirect','DICS_directcontrast_parcel','LCMV_anim_vs_Symb','-','DICS_anim', 'DICS_contrast_prestim', 'dSPM_contrast'};
...
switch LI_analysis
    ...
    case {2, 6, 7}
        ...
        for select_data = 1:length(dtag)
            ...
            cfg.Threshtype = 3;
            cfg.doavg = 1;
            [label_8net, LI_sub] = do_group_LI_net_contrast_parcel(cfg);
        end
    case 5
