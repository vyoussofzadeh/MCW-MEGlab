...
% cfg = struct('src_fname', src_fname, 'network_sel', [1,2,6], 'Data_hcp_atlas', Data_hcp_atlas, 'plotflag', 0);
% [idx_L, idx_R, src]  = do_plot_hcp_network(cfg);
% net_rois = 'ftp';
...
% cfg = struct('idx_L', idx_L, 'idx_R', idx_R, 'Data_hcp_atlas', Data_hcp_atlas, 'src_fname', src_fname, ...
%              'export', 1, 'savedir', fullfile(data_save_dir, 'group'), 'network_sel', [1,2,6]);
