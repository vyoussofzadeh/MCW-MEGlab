function [tbl3, idx3, tbl6] = do_barplot(pow_parcel,rois, thre, plotflag)
...
tbl1.Properties.VariableNames = {'val'};
...
tbl4 = table(round(pow_parcel,2)');
tbl4.Properties.VariableNames = {'val'};
tbl5 = cell2table(rois');
tbl5.Properties.VariableNames = {'region'};
tbl6 = [tbl4,tbl5];
% disp(tbl6)
