...
data_save_dir = '/data/MEG/Vahab/Github/MCW_MEGlab/MCW_MEGlab_git/Projects/ECP/SD/results/LI_subs/group';
...
% mLI_sub2 = squeeze(mean(LI_anim_pt.LI_sub,2)); tag = 'hc vs. pt, anim';
