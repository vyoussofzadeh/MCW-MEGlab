function S_data = ecpfunc_select_data(cfg)
...
switch cfg.select_data
    case 1
        J = 1; subcon = 'Ctrl'; sFiles_in = cfg.sub_demog_data.sFiles_anim_ctrl; 
        sFiles_subid = cfg.sub_demog_data.sub_anim_hc;  %- ctrl, Anim
    case 2
        J = 1; subcon = 'Patn'; sFiles_in = cfg.sub_demog_data.sFiles_anim_patn; 
        sFiles_subid = cfg.sub_demog_data.sub_anim_pt; %- Patn, Anim
    case 3
