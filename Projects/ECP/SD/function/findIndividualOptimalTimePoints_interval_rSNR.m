function [optimalIndices, maxDiff_opt] = findIndividualOptimalTimePoints_interval_rSNR(rSNR_left, rSNR_right, timePoints, subjectsForPlot, lowerBound, upperBound)
