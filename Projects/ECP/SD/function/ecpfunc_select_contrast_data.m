function S_data = ecpfunc_select_contrast_data(cfg)
...
%     case 3
%         J = 2; subcon = 'Ctrl'; sFiles_in = cfg.sub_demog_data.sFiles_symb_ctrl; 
%         sFiles_subid = cfg.sub_demog_data.sub_symb_hc; %- Ctrl, Symb
%     case 4
%         J = 2; subcon = 'Patn'; sFiles_in = cfg.sub_demog_data.sFiles_symb_patn; 
%         sFiles_subid = cfg.sub_demog_data.sub_symb_pt; %- Patn, Symb
end

taskcon = {'Anim', 'Symbol'};

sFiles_hc = 'Group_analysis/1_LCMV_Subjects/results_average_230110_2174.mat';
sFiles_pt = 'Group_analysis/1_LCMV_Subjects/results_average_230110_2175.mat';
...
% sFiles_hc_sFiles_pt = 'Group_analysis/@intra/results_221226_1142.mat';
...
switch cfg.select_data
    case 1
        s_avg_Input = sFiles_hc; s_tag = 'anim-hc';
    case 2
        s_avg_Input = sFiles_pt; s_tag = 'anim-pt';
%     case 3
