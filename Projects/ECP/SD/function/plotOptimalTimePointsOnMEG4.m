function plotOptimalTimePointsOnMEG4(rSNR_MEG, MEG_LI, fMRI_LI, wi, optimalIndices, discordantSamples, MEG_thre, Bound)
...
for subj = 1:numSubjects
    ...
    % Plot grey lines for the boundaries
    xline(timePoints(Bound(subj,1)), 'Color', [0.5 0 0.5], 'LineStyle', '-'); % Grey line for upper boundary
    xline(timePoints(Bound(subj,2)), 'Color', [0.5 0 0.5], 'LineStyle', '-'); % Grey line for lower boundary
