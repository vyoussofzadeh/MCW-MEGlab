function [groupCorrelation, optimalInterval, optimalInterval_all, pval] = computeGroupLevelMEGfMRICorrelation_timepoints_interval_peak(MEG_LI, fMRI_LI, timePoints, lowerBound, upperBound)
...
%     optimalTimePoints = findIndividualOptimalTimePoints(MEG_LI, fMRI_LI, timePoints, NaN, lowerBound, upperBound); % NaN means no plot
    [optimalIndices, optimalMEG_LI] = findIndividualOptimalTimePoints_interval_peak(MEG_LI, fMRI_LI, timePoints, NaN, lowerBound, upperBound); % NaN means no plot
