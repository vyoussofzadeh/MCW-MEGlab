function [MConcordance, BestLIMethod] = ecpfunc_optimalwindows(cfg_main)
...
if cfg_main.lowerBound >= cfg_main.upperBound || abs(cfg_main.lowerBound - cfg_main.upperBound) < 0.2
