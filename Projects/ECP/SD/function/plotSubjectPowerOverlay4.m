...
for subj = 1:numSubjects
    ...
    if plot_flag == 1
        ...
        subplot(ceil(numSubjects / 6), 6, subj); % Adjust layout based on the number of subjects
        hold on;
...
%     legend({'Left Hemisphere Power', 'Right Hemisphere Power', 'Optimal Time Point'}, 'Location', 'best');
    legend({'Left Power', 'Right Power', 'Power Difference'}, 'Location', 'best', 'Orientation', 'horizontal');
