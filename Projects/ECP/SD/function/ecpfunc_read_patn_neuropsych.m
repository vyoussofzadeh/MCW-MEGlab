...
% 
% % Import the data
% % patn lisa factors neuropsych matlab rsupdated final
% patn_neuropsych = readtable("/data/MEG/Research/ECP/Behavioural/update_pshah_060922/patn_lisa_factors_neuropsych_matlab_rs_updated_final.csv", opts);
% 
% clear SUBNO TLESide
% for i=1:size(patn_neuropsych,1)
%     SUBNO(i,:) = patn_neuropsych.SUBNO(i);
%     TLESide(i,:) = patn_neuropsych.TLESide(i);
% end
% 
