...
%                          'pVal','chi2','V','obsCounts'});

% comparisonStr = "2×3(Discord vs Concord)";

%% 1)  Initialise the summary table   now with obsCounts -------------
Tsummary2x3 = table( ...
        'Size'         ,[0 5], ...
        'VariableTypes',["string","string","string","double","cell"], ...
...
numVars = ["qVal"];     % adapt if you add more

for v = numVars
    Tsummary2x3.(v) = round(Tsummary2x3.(v), 2);      % 2-digit decimals
end
