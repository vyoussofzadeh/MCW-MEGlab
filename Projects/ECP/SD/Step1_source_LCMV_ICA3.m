%% ECP Semantic Decision Task Dataset Preprocessing
% Project: ECP_SD
...
%% Paths Setup
restoredefaultpath;
projectPath = '/data/MEG/Vahab/Github/MCW_MEGlab/MCW_MEGlab_git/Projects/ECP/SD';
cd(projectPath);
addpath('./run', './data', '/data/MEG/Vahab/Github/MCW_MEGlab/MCW_MEGlab_git/FT_fucntions/functions_new', '/data/MEG/Vahab/Github/MCW_MEGlab/MCW_MEGlab_git/FT_fucntions/helper');
Run_setpath;
...
%% Setup BS Directories and Load Protocol
...
%% Smoothing for Group Source Analysis
% Code block for smoothing source analysis
cd(BS_data_dir)
clc
dd = rdir(fullfile('./Group_analysis/ec*clean/results_*abs_ssmooth.mat'));
...
%% Contrast Data Conditions and Intra-subject Averaging
% Processing for contrast data conditions and averaging
...
bst_process('CallProcess', 'process_diff_ab', S_data.sFiles_3, S_data.sFiles_2, ...
    'source_abs', 1);
...
%
bst_process('CallProcess', 'process_test_parametric1',  sFiles_name(idx_3_smooth), [], ...
    'timewindow',    [-0.3, 2], ...
    'scoutsel',      {}, ...
    'scoutfunc',     1, ...  % Mean
    'isnorm',        0, ...
...
bst_process('CallProcess', 'process_test_parametric1',  sFiles_name(idx_2_smooth), [], ...
    'timewindow',    [-0.3, 2], ...
    'scoutsel',      {}, ...
    'scoutfunc',     1, ...  % Mean
    'isnorm',        0, ...
