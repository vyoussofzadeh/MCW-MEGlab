function [ChannelMat, R, T, isSkip, isUserCancel, strReport, tolerance] = channel_align_auto_ecp(ChannelFile, ChannelMat, isWarning, isConfirm, tolerance, ignorepercent)
