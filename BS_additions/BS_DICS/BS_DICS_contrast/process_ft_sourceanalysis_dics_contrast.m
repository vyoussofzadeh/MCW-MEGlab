function varargout = process_ft_sourceanalysis_dics_contrast(varargin )
...
sProcess.Comment     = 'FieldTrip: ft_sourceanalysis (DICS) contrast';
...
if (length(sInputsA) == 1)
    ...
    RefDataFile = sInputsA(iChanInputs(iInput)).FileName;
else
