...
%% ===== POPUP: DIPOLES =====
            case 'dipoles'
                ...
                if (length(bstNodes) == 1)
                    ...
                    gui_component('MenuItem', jPopup, [], 'Merge dipoles (5 subsets)', IconLoader.ICON_DIPOLES, [], @(h,ev)dipoles_merge_edited(GetAllFilenames(bstNodes))); % Edited by VY on 11/07/2022
                end
