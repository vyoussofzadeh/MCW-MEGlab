function [OutputFile, ChannelMat, ChannelReplace, ChannelAlign, Modality, Tolerance] = db_set_channel_edit( iStudy, ChannelMat, ChannelReplace, ChannelAlign, Tolerance)
...
if (ChannelAlign >= 1)
    ...
    % Call automatic registration for MEG (edited by VY, isConfirm = 0)
    [ChannelMat, R, T, isSkip, isUserCancel, strReport, Tolerance] = channel_align_auto(OutputFile, [], 0, 0, Tolerance);
