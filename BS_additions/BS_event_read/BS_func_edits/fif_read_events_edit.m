function [Events, ImportOptions] = fif_read_events_edit(sFile, ChannelMat, ImportOptions)
...
%                                            [], {'Pick file', 'Event channel', 'Ignore'}, 'Event channel');
    ...
    switch (res)
        ...
        case 'Event channel'
            % Read events channel
            [Events, EventsTrackMode, StimChan] = process_evt_read_nogui('Compute', sFile, ChannelMat, StimChan, 'value');
            EventFile = [];
