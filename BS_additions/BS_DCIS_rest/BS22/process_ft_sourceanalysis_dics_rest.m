...
cfg.foilim = [FOI, FOI];
cfg.plotflag  = 2;
cfg.taper    = 'dpss'; cfg.tapsmofrq  = TprFreq;
...
f_data = [];
[f_data.pst,~,~,~] = do_fft(cfg, ep_data); f_data.pst.elec = datain.grad;
cfg.foilim = [15 15];
cfg.tapsmofrq  = 12;
[f_data.bsl,~,~,~] = do_fft(cfg, ep_data); f_data.bsl.elec = datain.grad;
