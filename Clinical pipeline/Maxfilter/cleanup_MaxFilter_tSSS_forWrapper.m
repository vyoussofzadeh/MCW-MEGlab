function cleanup_MaxFilter_tSSS_forWrapper(subjIDpath, outDirpath)
...
% cd(indir)
ddir = string(subjIDpath); %'/MEG_data/epilepsy/@test_data/230424';
cd(ddir)
files = dir('*raw.fif');
outputSubDir = string(outDirpath);
...
for k = 1:length(files)
    ...
    outputSubDir = string(outDirpath); %/MEG_data/LAB_MEMBERS/candida/spike_detection_pts/schoemann_virginia/
