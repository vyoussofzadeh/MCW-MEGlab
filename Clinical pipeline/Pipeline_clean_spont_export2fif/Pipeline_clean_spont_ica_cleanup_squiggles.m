...
% cfg.hpfreq = 0.1;
% cfg.lpfreq = 40;
f_data_meg  = ft_preprocessing(cfg);
cfg.channel = {'EEG'};
f_data_eeg  = ft_preprocessing(cfg);
...
cln_data_meg = vy_ica_cleaning_light(cfg, f_data_meg);
cfg.lay = lay; 
cln_data_eeg = vy_ica_cleaning_light(cfg, f_data_eeg);
