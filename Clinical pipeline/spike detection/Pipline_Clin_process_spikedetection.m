...
if ETS_ask ==1
    ...
    %
    cfg = [];
    cfg.toilim = [un_time_occur(tselin) - kk,un_time_occur(tselin) + kk];
    data_spk = ft_redefinetrial(cfg, cln_data);
    ...
    kk = 0.5;
    cfg = [];
    cfg.latency = [un_time_occur(tselin) - kk,un_time_occur(tselin) + kk];
    cfg.channel  = 'S*';
    ...
    title([num2str(un_time_occur(tselin)), 'sec']);
