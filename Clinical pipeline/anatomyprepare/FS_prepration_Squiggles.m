...
%%
cd_org = '/data/MEG/Vahab/Github/MCW_MEGlab/MCW_MEGlab_git/Clinical pipeline/anatomyprepare';
addpath(cd_org)
% path_tools = '/usr/local/MATLAB_Tools';


%% Read the DICOM files
% dicomfile = '/group/jbinder/ECP/MEG/MEG_Work';
