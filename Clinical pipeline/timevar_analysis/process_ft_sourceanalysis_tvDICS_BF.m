...
function varargout = process_ft_sourceanalysis_tvDICS_BF(varargin )
...
sProcess.Comment     = 'FieldTrip: ft_sourceanalysis tv-DICS-BF v032420';
...
%         f = 22; tapsmofrq = 4;
        ...
        switch Method
            case 'dics'
                ResultsMat.ImageGridAmp  = abs(dicsmean')+0.01;
        ...
        ResultsMat.Comment       = ['tv_ft_sourceanalysis: ' Method, '_',num2str(f),'Hz_', datestr(now, 'dd/mm/yy-HH:MM')];
