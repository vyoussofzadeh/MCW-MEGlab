...
sProcess.Comment     = 'FieldTrip: ft_sourceanalysis Conn v100920';
...
sProcess.options.method.Value   = {'mne', {'LCMV beamformer', 'SAM beamformer', 'DICS beamformer', 'MNE', 'Conn', 'eLORETA', 'MUSIC', 'PCC', 'Residual variance'; ...
    'lcmv',            'sam',            'dics',            'mne', 'Conn', 'eloreta', 'music', 'pcc', 'rv'}};
...
%                 
%                 
%                 ft_old = '/MEG_data/Vahab/Github/tools/ft_packages/ft_old';
...
%                 cfg.parameter = gtm;
%                 cfg.operation = 'x1-x2';
%                 source_diff_dics = ft_math(cfg,network_pst,network_bsl);
%                 source_diff_dics.(gtm)   = zscore(source_diff_dics.(gtm));
%                 source_diff_dics.eigenvector_cent(source_diff_dics.eigenvector_cent<0)=0;
%                 %                 save('conn.mat', 'source_diff_dics')
%                 
%                 %%
%                 rmpath(genpath(ft_old));
%                 
                ...
                sourceAll = ft_sourceanalysis(cfg, f_data.app);
...
%                 cfg.pcc.fixedori    = 'yes'; % project on axis of most variance using SVD
                ...
                %%
%                 mtd = 'plv'; mtd_par = 'plvspctrm';
                mtd    = 'coh'; mtd_par = 'cohspctrm';
                gtm = 'eigenvector_cent';
                
                conn_par = [];
                conn_par.method   = mtd;
                conn_par.idx      = mtd_par;
                conn_par.complex  = 'absimag';
                
                net_par.gtm       = gtm ; in2 = 2;
                net_par.threshold = 0.1;
                [source_conn_bsl, ~] = vy_conn(s_data.bsl,conn_par,net_par);
                [source_conn_pst, ~] = vy_conn(s_data.pst,conn_par,net_par);
                
                %%
                mtd = [mtd,'spctrm']; % method par.
                ...
                conn_bsl = source_conn_bsl; conn_pst = source_conn_pst;
...
%                 source_diff_dics.eigenvector_cent(source_diff_dics.eigenvector_cent<0)=0;
        ...
        ResultsMat.ImageGridAmp  = abs((source_diff_dics.eigenvector_cent))+0.01;
