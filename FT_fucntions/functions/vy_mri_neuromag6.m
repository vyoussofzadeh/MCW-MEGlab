function [mri_realigned,individual_headmodel,headshape, individual_grid_8mm, individual_grid_10mm, brain] = vy_mri_neuromag6(cfg_main)
...
%         figure, ft_sourceplot([], individual_org_resliced);
        ...
        figure, ft_sourceplot([], individual_org);
