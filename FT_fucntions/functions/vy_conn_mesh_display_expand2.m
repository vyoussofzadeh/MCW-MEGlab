function tfilenameSURF=vy_conn_mesh_display_expand2(filenameSURF, idx)
...
try
    ...
    if numel(trefnames)>1&&numel(tfilenameSURF)==1 %3d-atlas
        ...
        if numel(trefnames)==maxdata
            listdlg('liststring',trefnames,'selectionmode','multiple','initialvalue',1:numel(trefnames),'promptstring','Select ROI:','ListSize',[300 200]);
