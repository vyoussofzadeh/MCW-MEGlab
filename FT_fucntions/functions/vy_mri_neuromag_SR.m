function out = vy_mri_neuromag_SR(cfg_main)
...
if exist(fullfile(cfg_main.outputmridir,['anat_',cfg_main.subj,'.mat']), 'file') == 2
    ...
    load(fullfile(cfg_main.outputmridir,['mesh8mm_',cfg_main.subj,'_indiv.mat']));
    load(fullfile(cfg_main.outputmridir,['mesh10mm_',cfg_main.subj,'_indiv.mat']));
else
    ...
    save(fullfile(cfg_main.outputmridir,['mesh8mm_',cfg_main.subj,'_indiv.mat']), 'individual_grid_8mm_indiv');
    save(fullfile(cfg_main.outputmridir,['mesh10mm_',cfg_main.subj,'_indiv.mat']), 'individual_grid_10mm_indiv');
...
out.individual_grid_8mm_indiv = individual_grid_8mm_indiv;
out.individual_grid_10mm_indiv = individual_grid_10mm_indiv;
%     end
...
if cfg_main.plotflag == 1
    ...
    hold on;
    ft_plot_headshape(headshape);
    ft_plot_mesh(individual_grid_10mm_indiv.pos(individual_grid_10mm_indiv.inside, :));
    view ([0 90])
    ...
    hold on;
    ft_plot_headshape(headshape);
    ft_plot_mesh(individual_grid_8mm_indiv.pos(individual_grid_8mm_indiv.inside, :));
    view ([0 90])
