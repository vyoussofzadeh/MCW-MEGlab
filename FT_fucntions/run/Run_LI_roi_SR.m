...
scoutFile = '/data/MEG/Projects/spendl/Spendl_FTimport/anat/@default_subject/scouts_tzourio-mazoyer.mat';
% scoutFile = '/data/MEG/Projects/spendl/Spendl_FTimport/anat/@default_subject/scouts_tzourio-mazoyer_mod_052020_vy.mat';
sScout = load(scoutFile);

%% Define Rois  Added 10/1/15 JStout
l = length(sScout.Scout);
if l ~= 88
...
%%
for i=1:length(sScout.Scout)
    mdk_roi(i) = mean(ImageGridAmp(sScout.Scout(i).Vertices));
end
