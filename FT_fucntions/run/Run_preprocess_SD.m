...
%     cfg.trials = find(f_data.trialinfo==2); % Famous
%     tl_data_1 = ft_timelockanalysis(cfg, f_data);
%     
%     cfg.trials = find(f_data.trialinfo==3); % Unfamiliar
%     tl_data_2 = ft_timelockanalysis(cfg, f_data);
%   
%     %-
%     figure
%     cfg = [];
...
%     cfg.interactive = 'yes';
%     cfg.showoutline = 'yes';
%     ft_multiplotER(cfg, f_data_1, f_data_2)
