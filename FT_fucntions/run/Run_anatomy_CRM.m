...
mridir = fullfile(outdir,subj,'anat');
...
clear fid
% if ~isempty(d)
mripfile = fullfile(mridir,'mri_resliced.nii');
...
% [individual_headmodel,headshape, individual_grid_8mm, individual_grid_10mm, brain] = vy_mri_neuromag7(cfg);
% [mri_realigned,individual_headmodel,headshape, individual_grid_8mm, individual_grid_10mm, brain] = vy_mri_neuromag7(cfg)
