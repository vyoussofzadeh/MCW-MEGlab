function [net_sel_mutiple_label, LI_sub] = do_group_LI_net_contrast_zscore(cfg_main)
...
if exist(savefilename,'file') == 2
    ...
    for j=1:length(net_sel_mutiple_label)
        ...
        cfg.atlas = Data_hcp_atlas.atlas; cfg.zthre = zthre; cfg.fplot = 0;
        cfg.index_L = idx_L{j};
        cfg.index_R = idx_R{j};
        ...
        for i=1:length(sFiles_in)
            ...
            elseif contains(method, 'Counting')
                [LI, ~] = do_lat_analysis_contrast_Counting_zscore(cfg);
