function [megLI_sub_pt, fmri_LIs_val, crr] = do_MEG_fMRI_corr(cfg_main)
...
%     mLI_sub2 = squeeze(mean(LI_symb_pt_val_new(net_sel,:,midx)));
%     mLI_sub_pt = mean((mLI_sub1 - mLI_sub2),2);
% else
%     mLI_sub1 = mean(LI_anim_pt_val_new(net_sel,:,idx-bf:idx+bf));
%     mLI_sub2 = mean(LI_symb_pt_val_new(net_sel,:,idx-bf:idx+bf));
%     mLI_sub_pt = mean((mLI_sub1 - mLI_sub2),2);
% end
