function out = do_wPLIconn1(cfg_main, source_active)
...
% foi = input('frequncy range [f1,f2]: ');

[~, idx_mn] = min(abs(foi(1) - source_conn1.freq));
[~, idx_mx] = min(abs(foi(2) - source_conn1.freq));
